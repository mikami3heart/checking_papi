...
// Xeon E5
	...
	//	"MEM_LOAD_UOPS_RETIRED:L1_MISS",	// Load miss in L1D
	//	"MEM_LOAD_UOPS_RETIRED:L2_MISS",	// Load miss in L2
	//	"MEM_LOAD_UOPS_RETIRED:L3_MISS",	// Load miss in L3
	//	"PAPI_L1_TCM",	// counts ICACHE:MISSES + L1D:REPLACEMENT
	//	"PAPI_L2_TCM",	// counts demand requests missed L2
	//	"PAPI_L3_TCM",	// counts demand requests missed L3	// inaccurate
...
//	"L2_RQSTS:PF_HIT",	// L2 hardware prefetchers that hit L2 $
	...
	//	"L2_RQSTS:REFERENCES",
	//	"L2_TRANS:ALL",				// IVY event name
	//	"L2_TRANS:ALL_REQUESTS",	// HASWELL event name
	//	"L2_TRANS:ALL_PF",
	//	"L2_TRANS:RFO",
	//	"L2_TRANS:L2_WB",
	//	"L2_TRANS:L1D_WB",
	//	"L2_TRANS:DMND_DATA_RD",	// IVY event name
	//	"L2_TRANS:DEMAND_DATA_RD",	// HASWELL event name
	//	"L2_TRANS:CODE_RD",
	//	"L2_TRANS:L2_FILL",

	//	"OFFCORE_REQUESTS:ALL_DATA_RD", == "OFFCORE_REQUESTS:ALL_DATA_READ",
	//	"OFFCORE_REQUESTS:DEMAND_CODE_RD",
	//	"OFFCORE_REQUESTS:DEMAND_DATA_RD",
	//	"OFFCORE_REQUESTS:DEMAND_RFO",

	//	"OFFCORE_RESPONSE_0:ANY_DATA:LLC_HITMESF",	// Sandy and Ivy
	//	"OFFCORE_RESPONSE_0:ANY_DATA:L3_HIT",	// Haswell
	//	"OFFCORE_RESPONSE_0:ANY_DATA:L3_MISS",
	//	"OFFCORE_RESPONSE_0:ANY_DATA:ANY_RESPONSE",

	//	"OFFCORE_RESPONSE_0:OTHER:ANY_RESPONSE",
	//	"OFFCORE_RESPONSE_0:OTHER:L3_MISS",
	//	"OFFCORE_RESPONSE_0:OTHER:L3_HIT",
	//	"OFFCORE_RESPONSE_0:OTHER:LLC_HITMESF",
	//	"OFFCORE_RESPONSE_0:ANY_DATA:L3_MISS",
	//	"OFFCORE_RESPONSE_0:ANY_RFO:L3_MISS",
	//	"OFFCORE_RESPONSE_0:ANY_RFO:LLC_HITMESF",

	//	"OFFCORE_RESPONSE_0:PF_DATA_RD:ANY_RESPONSE",
	//	"OFFCORE_RESPONSE_0:PF_DATA_RD:L3_MISS",
	//	"OFFCORE_RESPONSE_0:PF_DATA_RD:LLC_HITMESF",
	//	"OFFCORE_RESPONSE_0:PF_LLC_DATA_RD:L3_MISS",

	//	"OFFCORE_RESPONSE_0:ANY_REQUEST:ANY_RESPONSE",
	//	"OFFCORE_RESPONSE_0:ANY_RFO:ANY_RESPONSE",
	//	"OFFCORE_RESPONSE_0:ANY_DATA:LLC_HITMESF",
	//	"OFFCORE_RESPONSE_0:ANY_RFO:LLC_HITMESF",
	//	"OFFCORE_RESPONSE_0:ANY_DATA:ANY_RFO:L3_MISS:SNP_ANY",

// L3 hit events
	//	"OFFCORE_RESPONSE_0:ANY_DATA:LLC_HITMESF:SNP_ANY",	// IVY
// L3 miss events
	//	"OFFCORE_RESPONSE_0:ANY_DATA:L3_MISS:SNP_ANY",

// DEBUG from HERE!
// The following events can not be measured with ANY_DATA events. too bad.

// writeback events
"OFFCORE_RESPONSE_0:WB:ANY_RESPONSE",
	//	"OFFCORE_RESPONSE_0:WB:LLC_HITMESF:SNP_ANY",
	//	"OFFCORE_RESPONSE_0:WB:L3_MISS:SNP_ANY",
	//	"OFFCORE_RESPONSE_0:WB:L3_MISS",
// streaming stores
"OFFCORE_RESPONSE_0:STRM_ST:ANY_RESPONSE",
	//	"OFFCORE_RESPONSE_0:STRM_ST:LLC_HITMESF:SNP_ANY",
	//	"OFFCORE_RESPONSE_0:STRM_ST:L3_MISS",
	//	"OFFCORE_RESPONSE_0:STRM_ST:L3_MISS:SNP_ANY",
