...
cp $SRCDIR/check_papi_cache_fx100.cpp main.cpp
cp $SRCDIR/sub_kernel.c sub.c

CXXFLAGS="-Kopenmp,fast -Ntl_notrt -w"
#	CFLAGS="-Kopenmp,fast -O2 -Ntl_notrt -w"
#	CFLAGS="-Kopenmp,nosimd -O2 -Ntl_notrt -w"		# noSIMD
CFLAGS="-Kopenmp,HPC_ACE,fast -O2 -Ntl_notrt -w"	# 2SIMD
#	CFLAGS="-Kopenmp,HPC_ACE2,fast -O2 -Ntl_notrt -w"	# 4SIMD
